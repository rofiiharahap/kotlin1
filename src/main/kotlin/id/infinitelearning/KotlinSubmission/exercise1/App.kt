 ...
 */
fun myProfile() {
    val firtsName: String = "Muhammad Rofii "
    println("My First Name is : $firtsName")
    ...
    val Hubungan: Boolean = false
    val Hubungan2: Boolean = true

    println("Hubungan Kamu adalah = " + (Hubungan && Hubungan2))
    println("Hubungan Kamu adalah = " + (Hubungan || Hubungan2))
    println("Hubungan Kamu adalah = " + (!Hubungan2))
...
fun main() {
     ...
     *
     */
    groupDetail( "Group 1" , listOf("5 member", "Infinite Learning", "Lifestyle Fashion"), "Afternoon")
